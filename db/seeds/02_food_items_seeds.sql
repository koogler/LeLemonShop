...
('Hallows Brew', 'https://cdn.pixabay.com/photo/2020/10/27/12/32/drink-5690582_960_720.jpg', 'Intense halloween drinks if you are bold enough', 800),
('Sour Skids', 'https://pixabay.com/photos/gin-tonic-cocktail-lemon-alcohol-6875377/', 'Ready for something not-so-sweet? Extra lemon, less sugar is what you seek', 600),
('Marshmallows Eve', 'https://pixabay.com/photos/rodessa-rozhdesvensky-holiday-4672690/', 'A monster drink with blended sweets, lemonade, and marshmallows', 900);


-- False items for admin view: if functionality is added

-- INSERT INTO food_items (name, image, description, price, isactive)
-- VALUES
-- ('Hallows Brew', 'https://cdn.pixabay.com/photo/2020/10/27/12/32/drink-5690582_960_720.jpg', 'Intense halloween drinks if you are bold enough', 800, FALSE),
-- ('Sour Skids', 'www.lionness.com', 'Ready for something not-so-sweet? Extra lemon, less sugar is what you seek', 600, FALSE),
-- ('Marshmallows Eve', 'www.lionness.com', 'A monster drink with blended sweets, lemonade, and marshmallows', 900, FALSE);